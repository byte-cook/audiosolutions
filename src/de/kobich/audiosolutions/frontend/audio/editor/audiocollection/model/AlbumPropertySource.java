...
public class AlbumPropertySource implements IPropertySource {
	...
	private AlbumTreeNode albumTreeNode;
	
	public AlbumPropertySource(AlbumTreeNode fileDescriptorTreeNode) {
	...
	public IPropertyDescriptor[] getPropertyDescriptors() {
		if (propertyDescriptors == null) {
			...
			PropertyDescriptor pathPropertyDesc = new PropertyDescriptor(PROPERTY_ALBUM, PROPERTY_ALBUM);
	...
	public Object getPropertyValue(Object property) {
		if (PROPERTY_ALBUM.equals(property)) {
