...
import de.kobich.audiosolutions.core.service.imexport.metadata.AudioDataImporter;
 ...
 * Exports files.
 */
public class AudioCollectionImportWizard extends Wizard implements IExportWizard {
	private static final Logger logger = Logger.getLogger(AudioCollectionImportWizard.class); 
	...
	public boolean performFinish() {
		try {
			...
			AudioDataImporter audioDataImporter = AudioSolutions.getService(AudioDataImporter.class);
			metaDataImporters.add(audioDataImporter);
			...
			AudioCollectionEditor editor = (AudioCollectionEditor) workbenchPage.openEditor(fileCollection, AudioCollectionEditor.ID);
	...
	public void init(IWorkbench workbench, IStructuredSelection structuredSelection) {
		...
		this.page = AudioCollectionImExportWizardPage.createImportPage();
	...
	private class RunnableWithProgress implements IRunnableWithProgress {
		...
		public void run(IProgressMonitor monitor) {
			...
			try {
				...
				logger.error("Files could not be imported", exc);
