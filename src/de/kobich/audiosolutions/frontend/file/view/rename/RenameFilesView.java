...
public class RenameFilesView extends ViewPart implements IMementoItemSerializable {
	...
	public void createPartControl(Composite parent) {
		...
		tabViews = new RenameFilesBaseTabView[8];
		...
		tabViews[4] = new RenameFilesAttributeTabView(previewListener);
		tabViews[5] = new RenameFilesAutoNumberingTabView(previewListener);
		tabViews[6] = new RenameFilesCaseTabView(previewListener);
		tabViews[7] = new RenameFilesSwappingTabView(previewListener);
