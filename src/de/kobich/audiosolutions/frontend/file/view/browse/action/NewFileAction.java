 ...
 * 
 */
public class NewFileAction extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		QueryTextDialog dialog = QueryTextDialog.createDialog(window.getShell(), "New File", "Create new file in: \n" + directory.getPath(),
				"File Name:", "");
		...
		if (status == IDialogConstants.OK_ID) {
			try {
				...
				FileResult result = fileIOService.createNewFiles(request);
				...
				MessageDialog.openError(window.getShell(), "New File", "New file could not be created: \n" + exc.getMessage());
			}
		}
		return null;
	}
